...
<template>
  <div class="action-run-summary-view">
    ...
    <WorkflowGraph
      ...
      :store="store"
      :jobs="topLevelJobs"
      :run-link="run.viewLink"
      :workflow-id="run.workflowID"
      :locale="locale"
    />
    <div v-else class="action-run-empty-state">
      <strong>No jobs captured for this run yet.</strong>
      <span>act-gui will attach jobs, steps, logs, and progress here as act emits runner output.</span>
    </div>
  </div>
</template>
<style scoped>
